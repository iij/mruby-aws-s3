module AWS
  class S3
    ...
    def initialize(access_key: nil, secret_key: nil, security_token: nil, region: nil, bucket_name: nil)
      ...
      @s3_endpoint = "https://#{bucket_name}.s3.#{@region}.amazonaws.com"
    ...
    def calculate_signature(method, path, headers)
      ...
      signing_key = scope.inject(signing_key) do |k, v|
